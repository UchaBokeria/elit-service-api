...
require './Modules/Learner/Learner.ErrorReport.php';
require './Modules/Learner/Learner.LibrariesFuncs.php';
require './Modules/Logger/Logger.php';
require './Modules/Database/Database.php';
require './Modules/Mailer/SmtpMailer.php';
require './Modules/Guardian/Guardian.php';
require './Modules/Decorator/Decorator.php';
require './Modules/Learner/Learner.Controllers.php';
require './Modules/Learner/Learner.JsonResults.php';